...
<body>
	...
	<s:form action = "updateBook" class="myLib.BookCrud"  method = "post" cssClass="addform" theme="css_xhtml">
		<h1>update book...</h1>
		<s:textfield type="hidden" name="ISBN" value="%{#parameters.ISBN}"/>
		<s:textfield name = "Name" label = "Author" placeholder="for example: cl NG"></s:textfield>
		<s:textfield name = "Publisher" label = "Publisher" placeholder="for example:Milk Express"></s:textfield>
		<s:textfield name = "PublishDate" label = "Publish Date" placeholder="for example:2001-01-01"></s:textfield>
		<s:textfield name = "Price" label = "Price" placeholder="for example:32.12"></s:textfield>
